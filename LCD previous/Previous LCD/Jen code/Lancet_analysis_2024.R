...
####################################################
### Process data from GEE (repeat for each year) ###
####################################################
fall_2016<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_Fall_AllCities.csv")
colnames(fall_2016)
fall_2016<-fall_2016[,c(329,32,334,341)]
fall_2016<-fall_2016[order(fall_2016$Urban_area),]

winter_2016<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_Winter_AllCities.csv")
colnames(winter_2016)
winter_2016<-winter_2016[,c(329,32,334,341)]
winter_2016<-winter_2016[order(winter_2016$Urban_area),]

spring_2016<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_Spring_AllCities.csv")
colnames(spring_2016)
spring_2016<-spring_2016[,c(329,32,334,341)]
spring_2016<-spring_2016[order(spring_2016$Urban_area),]

summer_2016<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_Summer_AllCities.csv")
colnames(summer_2016)
summer_2016<-summer_2016[,c(329,32,334,341)]
summer_2016<-summer_2016[order(summer_2016$Urban_area),]

all_seasons_2016<-rbind(fall_2016,winter_2016,spring_2016,summer_2016)
all_seasons_2016<-aggregate(all_seasons_2016, by=list(all_seasons_2016$Urban_area,
                                                      all_seasons_2016$Country,
                                                      all_seasons_2016$XC_ISO_LST),FUN=mean, na.rm=TRUE)
names(all_seasons_2016)[7]<-"annual_avg_2016"
names(all_seasons_2016)[1:3]<-c('City','Country','XC_ISO_LST')
all_seasons_2016<-all_seasons_2016[,-c(4:6)]
all_seasons_2016<-all_seasons_2016[order(all_seasons_2016$Country,all_seasons_2016$City),]

all_season_2016_max<-rbind(fall_2016,winter_2016,spring_2016,summer_2016)
all_season_2016_max<-aggregate(all_season_2016_max, by=list(all_season_2016_max$Urban_area,
                                                            all_season_2016_max$Country,
                                                            all_season_2016_max$XC_ISO_LST),FUN=max, na.rm=TRUE)
all_season_2016_max[289,7]<-"NA"
names(all_season_2016_max)[7]<-"max_NDVI_2016"
names(all_season_2016_max)[1:3]<-c('City','Country','XC_ISO_LST')
all_season_2016_max<-all_season_2016_max[,-c(4:6)]
all_season_2016_max<-all_season_2016_max[order(all_season_2016_max$Country,all_season_2016_max$City),]
mean(as.numeric(all_season_2016_max$max_NDVI_2016),na.rm=TRUE)
#0.3532309

cumavg_max_2016<-cbind(all_season_2016_max,all_seasons_2016)
cumavg_max_2016<-cumavg_max_2016[,-c(5:7)]
names(cumavg_max_2016)
write.csv(cumavg_max_2016,"C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/2016_cumavg_max.csv")
...
fall_2016sum<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_sum1_fall_AllCities.csv")
colnames(fall_2016sum)
fall_2016sum<-fall_2016sum[,c(329,32,334,342)]
fall_2016sum<-fall_2016sum[order(fall_2016sum$Country,fall_2016sum$Urban_area),]

winter_2016sum<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_sum1_winter_AllCities.csv")
colnames(winter_2016sum)
winter_2016sum<-winter_2016sum[,c(329,32,334,342)]
winter_2016sum<-winter_2016sum[order(winter_2016sum$Country,winter_2016sum$Urban_area),]

spring_2016sum<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_sum1_spring_AllCities.csv")
colnames(spring_2016sum)
spring_2016sum<-spring_2016sum[,c(329,32,334,342)]
spring_2016sum<-spring_2016sum[order(spring_2016sum$Country,spring_2016sum$Urban_area),]

summer_2016sum<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2016_sum1_summer_AllCities.csv")
colnames(summer_2016sum)
summer_2016sum<-summer_2016sum[,c(329,32,334,342)]
summer_2016sum<-summer_2016sum[order(summer_2016sum$Country,summer_2016sum$Urban_area),]


all_seasons_2016sum<-rbind(fall_2016sum,winter_2016sum,spring_2016sum,summer_2016sum)
all_seasons_2016sum<-aggregate(all_seasons_2016sum, by=list(all_seasons_2016sum$Urban_area,all_seasons_2016sum$Country,
                                                            all_seasons_2016sum$XC_ISO_LST),FUN=mean)

names(all_seasons_2016sum)[7]<-"cumavg_Sum1_2016"
names(all_seasons_2016sum)[1:3]<-c('City','Country','XC_ISO_LST')
all_seasons_2016sum<-all_seasons_2016sum[,-c(4:6)]
all_seasons_2016sum<-all_seasons_2016sum[order(all_seasons_2016sum$Country,all_seasons_2016sum$City),]
write.csv(all_seasons_2016sum,"C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/all_seasons_2016sum.csv")

all_season_2016_max<-rbind(fall_2016sum,winter_2016sum,spring_2016sum,summer_2016sum)
all_season_2016_max<-aggregate(all_season_2016_max, by=list(all_season_2016_max$Urban_area,all_season_2016_max$Country,
                                                            all_season_2016_max$XC_ISO_LST),FUN=max)
names(all_season_2016_max)[7]<-"max_Sum1_2016"
names(all_season_2016_max)[1:3]<-c('City','Country','XC_ISO_LST')
all_season_2016_max<-all_season_2016_max[,-c(4:6)]
all_season_2016_max<-all_season_2016_max[order(all_season_2016_max$Country,all_season_2016_max$City),]
write.csv(all_season_2016_max,"C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/all_seasons_2016max.csv")

#be sure to read in 2020_sum2 file here
sum2_2016<-read.csv("C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/GEE Data Files/2020_sum2_popsize_AllCities.csv")
colnames(sum2_2016)
sum2_2016<-sum2_2016[,c(329,32,334,342)]
names(sum2_2016)[4]<-"sum2"
names(sum2_2016)[1]<-"City"
sum2_2016<-sum2_2016[order(sum2_2016$Country,sum2_2016$City),]

pop_cumav_2016<-cbind(all_seasons_2016sum,all_season_2016_max)
pop_cumav_2016<-pop_cumav_2016[,-c(5:7)]

pop_cumav_2016<-cbind(pop_cumav_2016,sum2_2016)
names(pop_cumav_2016)
pop_cumav_2016<-pop_cumav_2016[,-c(6:8)]
#pop_cumav_2016<-pop_cumav_2016[,-c(7:352)]

pop_cumav_2016$cum_popweighted_avg<-pop_cumav_2016$cumavg_Sum1_2016/pop_cumav_2016$sum2
pop_cumav_2016$max_popweighted<-pop_cumav_2016$max_Sum1_2016/pop_cumav_2016$sum2

write.csv(pop_cumav_2016,"C:/Users/stowellj/OneDrive - Boston University/Lancet countdown/Lancet 2024/2016_popweighted_cumavg_max.csv")


############################################
####### Import and clean data for all years
############################################

#Import GEE results for 2015 
results2015<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2015_cumavg_max.csv")  
df_uniq<-unique(results2015$Country)
length(df_uniq)
names(results2015)
results2015$peak.NDVI_2015<-as.numeric(results2015$max_NDVI)
results2015$max_NDVI_2015<-NULL

results2015pop<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2015_popweighted_cumavg_max.csv")  
df_uniq<-unique(results2015pop$Country)
length(df_uniq)
names(results2015pop)

data2015<-merge(results2015, results2015pop, by='City')
names(data2015)
data2015<-data2015[,c(1,3:6,10:14)]
names(data2015)<-c('City','Country','XC_ISO_LST','cumavg_2015',
                   'peak.NDVI_2015','cumavg_Sum1_2015','max_Sum1_2015',
                   'sum2','cum_popweighted_avg','max_popweighted')


#Import GEE results for 2016 
results2016<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2016_cumavg_max.csv")  
df_uniq<-unique(results2016$Country)
length(df_uniq)
names(results2016)
results2016$peak.NDVI_2016<-as.numeric(results2016$max_NDVI)
results2016$max_NDVI_2016<-NULL

results2016pop<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2016_popweighted_cumavg_max.csv")  
df_uniq<-unique(results2016pop$Country)
length(df_uniq)
names(results2016pop)

data2016<-merge(results2016, results2016pop, by='City')
names(data2016)
data2016<-data2016[,c(1,3:6,10:14)]
names(data2016)<-c('City','Country','XC_ISO_LST','cumavg_2016',
                   'peak.NDVI_2016','cumavg_Sum1_2016','max_Sum1_2016',
                   'sum2','cum_popweighted_avg','max_popweighted')

#Import GEE results for 2020 
results2020<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2020_cumavg_max.csv")  
df_uniq<-unique(results2020$Country)
length(df_uniq)
names(results2020)
results2020$peak.NDVI_2020<-as.numeric(results2020$max_NDVI_2020)
results2020$max_NDVI_2020<-NULL

results2020pop<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2020_popweighted_cumavg_max.csv")  
df_uniq<-unique(results2020pop$Country)
length(df_uniq)
names(results2020pop)

data2020<-merge(results2020, results2020pop, by='City')
names(data2020)
data2020<-data2020[,c(1,3:6,10:14)]
names(data2020)<-c('City','Country','XC_ISO_LST','cumavg_2020',
                   'peak.NDVI_2020','cumavg_Sum1_2020','max_Sum1_2020',
                   'sum2','cum_popweighted_avg','max_popweighted')


#Import GEE results for 2021 
results2021<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2021_cumavg_max.csv")  
df_uniq<-unique(results2021$Country)
length(df_uniq)
names(results2021)
results2021$peak.NDVI_2021<-as.numeric(results2021$max_NDVI_2021)
results2021$max_NDVI_2021<-NULL

results2021pop<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2021_popweighted_cumavg_max.csv")  
df_uniq<-unique(results2021pop$Country)
length(df_uniq)
names(results2021pop)

data2021<-merge(results2021, results2021pop, by='City')
names(data2021)
data2021<-data2021[,c(1,3:6,10:14)]
names(data2021)<-c('City','Country','XC_ISO_LST','cumavg_2021',
                   'peak.NDVI_2021','cumavg_Sum1_2021','max_Sum1_2021',
                   'sum2','cum_popweighted_avg','max_popweighted')


#Import GEE results for 2022 
results2022<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2022_cumavg_max.csv")  
df_uniq<-unique(results2022$Country)
length(df_uniq)
names(results2022)
results2022$peak.NDVI_2022<-as.numeric(results2022$max_NDVI_2022)
results2022$max_NDVI_2022<-NULL

results2022pop<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2022_popweighted_cumavg_max.csv")  
df_uniq<-unique(results2022pop$Country)
length(df_uniq)
names(results2022pop)

data2022<-merge(results2022, results2022pop, by='City')
names(data2022)
data2022<-data2022[,c(1,3:6,10:14)]
names(data2022)<-c('City','Country','XC_ISO_LST','cumavg_2022',
                   'peak.NDVI_2022','cumavg_Sum1_2022','max_Sum1_2022',
                   'sum2','cum_popweighted_avg','max_popweighted')

#Import GEE results for 2023 
results2023<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2023_cumavg_max.csv")  
df_uniq<-unique(results2023$Country)
length(df_uniq)
names(results2023)
results2023$peak.NDVI_2023<-as.numeric(results2023$max_NDVI_2023)
results2023$max_NDVI_2023<-NULL

results2023pop<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2024//2023_popweighted_cumavg_max.csv")  
df_uniq<-unique(results2023pop$Country)
length(df_uniq)
names(results2023pop)

data2023<-merge(results2023, results2023pop, by='City')
names(data2023)
data2023<-data2023[,c(1,3:6,10:14)]
names(data2023)<-c('City','Country','XC_ISO_LST','cumavg_2023',
                   'peak.NDVI_2023','cumavg_Sum1_2023','max_Sum1_2023',
                   'sum2','cum_popweighted_avg','max_popweighted')

#To code county variable before joining
# country_hdi<-read.csv("C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2022//country_hdi.csv")
# country_hdi<-country_hdi %>%
#   mutate(hdi_level=case_when(
#     X2019<0.55 ~ "Low",
#     X2019>=0.55 & X2019<=0.699~"Medium",
#     X2019>=0.700 & X2019<=0.799~"High",
#     X2019>=0.800~"Very high"
#   ))
# country_hdi$Country<-trimws(country_hdi$Country)
# 
# write.csv(country_hdi,"C://Users//stowellj//OneDrive - Boston University//Lancet countdown//Lancet 2022//country_hdi_coded.csv")
