...
ggplot() +
  ...
  xlab('Year') + ylab('Pop-weighted Avg season NDVI')+ facet_wrap(~lc_group, ncol=4)
...
ggplot() +
  ...
  xlab('Year') + ylab('Pop-weighted Avg season NDVI')+ facet_wrap(~who_region, ncol=4)
...
long_pctChange <- subset(long_pctChange, !city %in% c("Reykjavik"))

#set up the file to save figure
pdf(file = "graphs/line graph pct change average no Reykjavik.pdf", width=13.5, height=8.5)
...
ggplot() +
  ...
  xlab('Year') + ylab('% change in pop-weighted average season NDVI')+ facet_wrap(~lc_group, ncol=4)
...
ggplot() +
  ...
  xlab('Year') + ylab('Pop-weighted average season NDVI')+ facet_wrap(~who_region, ncol=4)
...
ggplot() +
  ...
  xlab('Year') + ylab('Pop-weighted average season NDVI')+ facet_wrap(~sub.region, ncol=4)
dev.off()
