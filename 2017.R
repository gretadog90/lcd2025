################################################################
# Import 2017 GEE data to create the yearly NDVI metrics
################################################################
...
#for each file in file list, rename to drop "2017_" and ".csv" and read in csv as object
...
seasons_popw_100m<- seasons_popw_100m %>%
  ...
  summarize(annual_avg_num_2017_100m = mean(sum, na.rm = TRUE), 
            annual_max_num_2017_100m = max(sum, na.rm = TRUE) )
...
seasons_popw_100m$PopWeight_Avg_NDVI_2017_100m<-seasons_popw_100m$annual_avg_num_2017_100m/seasons_popw_100m$Population_2015_100m
seasons_popw_100m$PopWeight_Peak_NDVI_2017_100m<-seasons_popw_100m$annual_max_num_2017_100m/seasons_popw_100m$Population_2015_100m
