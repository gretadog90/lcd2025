...
# see what graphs looks like w/o Reykjavik
lcd2025_pctChange <- subset(lcd2025_pctChange, !city %in% c("Reykjavik", "Saint Petersburg"))
...
#set up the file to save figure
pdf(file = "graphs/line graph pct change no Reykjavik or St Petersburg.pdf", width=13.5, height=8.5)
